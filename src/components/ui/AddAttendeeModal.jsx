                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      value={formData?.role}
                      onChange={handleChange}
                      className="w-full px-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-gray-900 appearance-none cursor-pointer text-sm pr-4 py-0.5">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3 p-3 bg-gray-50 border border-gray-200 rounded-lg">
                  <input
                    ...
                    name="selfSignOutConsent"
                    checked={formData?.selfSignOutConsent}
                    onChange={(e) => handleChange({ target: { name: 'selfSignOutConsent', value: e?.target?.checked } })}
                    className="w-4 h-4 text-blue-600 bg-white border-gray-300 rounded focus:ring-blue-500 focus:ring-2 cursor-pointer" />
